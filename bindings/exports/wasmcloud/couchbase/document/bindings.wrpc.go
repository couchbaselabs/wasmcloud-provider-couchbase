...
func ServeInterface(s wrpc.Server, h Handler) (stop func() error, err error) {
	...
	stop0, err := s.Serve("wasmcloud:couchbase/document@0.1.0-draft", "insert", func(ctx context.Context, w wrpc.IndexWriteCloser, r wrpc.IndexReadCloser) {
		...
		p1, err := func() (*Document, error) {
			v, err := func(r wrpc.IndexReader, path ...uint32) (*wasmcloud__couchbase__types.Document, error) {
		...
		p2, err := func(r wrpc.IndexReader, path ...uint32) (*DocumentInsertOptions, error) {
			...
			case 1:
				...
				v, err := func(r wrpc.IndexReader, path ...uint32) (*DocumentInsertOptions, error) {
					...
					v.TimeoutNs, err = func(r wrpc.IndexReader, path ...uint32) (*uint64, error) {
						slog.Debug("reading option status byte")
						status, err := r.ReadByte()
						if err != nil {
							return nil, fmt.Errorf("failed to read option status byte: %w", err)
					...
					v.RetryStrategy, err = func(r wrpc.IndexReader, path ...uint32) (*RetryStrategy, error) {
						slog.Debug("reading option status byte")
						status, err := r.ReadByte()
						if err != nil {
							return nil, fmt.Errorf("failed to read option status byte: %w", err)
						...
						case 1:
							...
							v, err := func() (*RetryStrategy, error) {
								v, err := func(r wrpc.IndexReader, path ...uint32) (*wasmcloud__couchbase__types.RetryStrategy, error) {
									...
									case wasmcloud__couchbase__types.RetryStrategyIntervalTimesMs:
										payload, err := func(r wrpc.IndexReader, path ...uint32) (*wrpc.Tuple2[uint64, uint64], error) {
					...
					v.ParentSpan, err = func(r wrpc.IndexReader, path ...uint32) (*RequestSpan, error) {
						slog.Debug("reading option status byte")
						status, err := r.ReadByte()
						if err != nil {
							return nil, fmt.Errorf("failed to read option status byte: %w", err)
		...
		if err != nil {
			slog.WarnContext(ctx, "failed to write result value", "i", 0, "wasmcloud:couchbase/document@0.1.0-draft", "name", "insert", "err", err)
			return
		}
		if write0 != nil {
			writes[0] = write0
		...
		if err != nil {
			slog.WarnContext(ctx, "failed to write result", "wasmcloud:couchbase/document@0.1.0-draft", "name", "insert", "err", err)
			return
		}
		if len(writes) > 0 {
			for index, write := range writes {
				w, err := w.Index(index)
				if err != nil {
					slog.ErrorContext(ctx, "failed to index writer", "index", index, "wasmcloud:couchbase/document@0.1.0-draft", "name", "insert", "err", err)
					return
				}
				index := index
				write := write
				go func() {
					if err := write(w); err != nil {
						slog.WarnContext(ctx, "failed to write nested result value", "index", index, "wasmcloud:couchbase/document@0.1.0-draft", "name", "insert", "err", err)
					}
				}()
			}
		}
	...
	stop1, err := s.Serve("wasmcloud:couchbase/document@0.1.0-draft", "replace", func(ctx context.Context, w wrpc.IndexWriteCloser, r wrpc.IndexReadCloser) {
		...
		slog.DebugContext(ctx, "reading parameter", "i", 2)
		p2, err := func(r wrpc.IndexReader, path ...uint32) (*DocumentReplaceOptions, error) {
			slog.Debug("reading option status byte")
			status, err := r.ReadByte()
			if err != nil {
				return nil, fmt.Errorf("failed to read option status byte: %w", err)
			...
			case 1:
				slog.Debug("reading `option::some` payload")
				v, err := func(r wrpc.IndexReader, path ...uint32) (*DocumentReplaceOptions, error) {
		...
		if err != nil {
			slog.WarnContext(ctx, "failed to write result value", "i", 0, "wasmcloud:couchbase/document@0.1.0-draft", "name", "replace", "err", err)
			return
		}
		if write0 != nil {
			writes[0] = write0
		...
		_, err = w.Write(buf.Bytes())
		if err != nil {
			slog.WarnContext(ctx, "failed to write result", "wasmcloud:couchbase/document@0.1.0-draft", "name", "replace", "err", err)
			return
		}
		if len(writes) > 0 {
			for index, write := range writes {
				w, err := w.Index(index)
				if err != nil {
					slog.ErrorContext(ctx, "failed to index writer", "index", index, "wasmcloud:couchbase/document@0.1.0-draft", "name", "replace", "err", err)
					return
				}
				index := index
				write := write
				go func() {
					if err := write(w); err != nil {
						slog.WarnContext(ctx, "failed to write nested result value", "index", index, "wasmcloud:couchbase/document@0.1.0-draft", "name", "replace", "err", err)
					}
				}()
			}
		}
	...
	stop2, err := s.Serve("wasmcloud:couchbase/document@0.1.0-draft", "upsert", func(ctx context.Context, w wrpc.IndexWriteCloser, r wrpc.IndexReadCloser) {
		...
		slog.DebugContext(ctx, "reading parameter", "i", 2)
		p2, err := func(r wrpc.IndexReader, path ...uint32) (*DocumentUpsertOptions, error) {
			slog.Debug("reading option status byte")
			status, err := r.ReadByte()
			if err != nil {
				return nil, fmt.Errorf("failed to read option status byte: %w", err)
			...
			case 1:
				slog.Debug("reading `option::some` payload")
				v, err := func(r wrpc.IndexReader, path ...uint32) (*DocumentUpsertOptions, error) {
		...
		if err != nil {
			slog.WarnContext(ctx, "failed to write result value", "i", 0, "wasmcloud:couchbase/document@0.1.0-draft", "name", "upsert", "err", err)
			return
		}
		if write0 != nil {
			writes[0] = write0
		...
		_, err = w.Write(buf.Bytes())
		if err != nil {
			slog.WarnContext(ctx, "failed to write result", "wasmcloud:couchbase/document@0.1.0-draft", "name", "upsert", "err", err)
			return
		}
		if len(writes) > 0 {
			for index, write := range writes {
				w, err := w.Index(index)
				if err != nil {
					slog.ErrorContext(ctx, "failed to index writer", "index", index, "wasmcloud:couchbase/document@0.1.0-draft", "name", "upsert", "err", err)
					return
				}
				index := index
				write := write
				go func() {
					if err := write(w); err != nil {
						slog.WarnContext(ctx, "failed to write nested result value", "index", index, "wasmcloud:couchbase/document@0.1.0-draft", "name", "upsert", "err", err)
					}
				}()
			}
		}
	...
	stop3, err := s.Serve("wasmcloud:couchbase/document@0.1.0-draft", "get", func(ctx context.Context, w wrpc.IndexWriteCloser, r wrpc.IndexReadCloser) {
		...
		slog.DebugContext(ctx, "reading parameter", "i", 1)
		p1, err := func(r wrpc.IndexReader, path ...uint32) (*DocumentGetOptions, error) {
			slog.Debug("reading option status byte")
			status, err := r.ReadByte()
			if err != nil {
				return nil, fmt.Errorf("failed to read option status byte: %w", err)
			...
			case 1:
				slog.Debug("reading `option::some` payload")
				v, err := func(r wrpc.IndexReader, path ...uint32) (*DocumentGetOptions, error) {
					...
					v.Project, err = func(r wrpc.IndexReader, path ...uint32) ([]string, error) {
						slog.Debug("reading option status byte")
						status, err := r.ReadByte()
						if err != nil {
							return nil, fmt.Errorf("failed to read option status byte: %w", err)
						...
						case 1:
							slog.Debug("reading `option::some` payload")
							v, err := func(r wrpc.IndexReader, path ...uint32) ([]string, error) {
								var x uint32
								var s uint
								for i := 0; i < 5; i++ {
					...
					v.UseReplica, err = func(r wrpc.IndexReader, path ...uint32) (*ReplicaReadLevel, error) {
						slog.Debug("reading option status byte")
						status, err := r.ReadByte()
						if err != nil {
							return nil, fmt.Errorf("failed to read option status byte: %w", err)
		...
		if err != nil {
			slog.WarnContext(ctx, "failed to write result value", "i", 0, "wasmcloud:couchbase/document@0.1.0-draft", "name", "get", "err", err)
			return
		}
		if write0 != nil {
			writes[0] = write0
		...
		_, err = w.Write(buf.Bytes())
		if err != nil {
			slog.WarnContext(ctx, "failed to write result", "wasmcloud:couchbase/document@0.1.0-draft", "name", "get", "err", err)
			return
		}
		if len(writes) > 0 {
			for index, write := range writes {
				w, err := w.Index(index)
				if err != nil {
					slog.ErrorContext(ctx, "failed to index writer", "index", index, "wasmcloud:couchbase/document@0.1.0-draft", "name", "get", "err", err)
					return
				}
				index := index
				write := write
				go func() {
					if err := write(w); err != nil {
						slog.WarnContext(ctx, "failed to write nested result value", "index", index, "wasmcloud:couchbase/document@0.1.0-draft", "name", "get", "err", err)
					}
				}()
			}
		}
	...
	stop4, err := s.Serve("wasmcloud:couchbase/document@0.1.0-draft", "get-any-repliacs", func(ctx context.Context, w wrpc.IndexWriteCloser, r wrpc.IndexReadCloser) {
		...
		slog.DebugContext(ctx, "reading parameter", "i", 1)
		p1, err := func(r wrpc.IndexReader, path ...uint32) (*DocumentGetAnyReplicaOptions, error) {
			slog.Debug("reading option status byte")
			status, err := r.ReadByte()
			if err != nil {
				return nil, fmt.Errorf("failed to read option status byte: %w", err)
			...
			case 1:
				slog.Debug("reading `option::some` payload")
				v, err := func(r wrpc.IndexReader, path ...uint32) (*DocumentGetAnyReplicaOptions, error) {
		...
		if err != nil {
			slog.WarnContext(ctx, "failed to write result value", "i", 0, "wasmcloud:couchbase/document@0.1.0-draft", "name", "get-any-repliacs", "err", err)
			return
		}
		if write0 != nil {
			writes[0] = write0
		...
		_, err = w.Write(buf.Bytes())
		if err != nil {
			slog.WarnContext(ctx, "failed to write result", "wasmcloud:couchbase/document@0.1.0-draft", "name", "get-any-repliacs", "err", err)
			return
		}
		if len(writes) > 0 {
			for index, write := range writes {
				w, err := w.Index(index)
				if err != nil {
					slog.ErrorContext(ctx, "failed to index writer", "index", index, "wasmcloud:couchbase/document@0.1.0-draft", "name", "get-any-repliacs", "err", err)
					return
				}
				index := index
				write := write
				go func() {
					if err := write(w); err != nil {
						slog.WarnContext(ctx, "failed to write nested result value", "index", index, "wasmcloud:couchbase/document@0.1.0-draft", "name", "get-any-repliacs", "err", err)
					}
				}()
			}
		}
	...
	stop5, err := s.Serve("wasmcloud:couchbase/document@0.1.0-draft", "get-all-replicas", func(ctx context.Context, w wrpc.IndexWriteCloser, r wrpc.IndexReadCloser) {
		...
		slog.DebugContext(ctx, "reading parameter", "i", 1)
		p1, err := func(r wrpc.IndexReader, path ...uint32) (*DocumentGetAllReplicaOptions, error) {
			slog.Debug("reading option status byte")
			status, err := r.ReadByte()
			if err != nil {
				return nil, fmt.Errorf("failed to read option status byte: %w", err)
			...
			case 1:
				slog.Debug("reading `option::some` payload")
				v, err := func(r wrpc.IndexReader, path ...uint32) (*DocumentGetAllReplicaOptions, error) {
		...
		if err != nil {
			slog.WarnContext(ctx, "failed to write result value", "i", 0, "wasmcloud:couchbase/document@0.1.0-draft", "name", "get-all-replicas", "err", err)
			return
		}
		if write0 != nil {
			writes[0] = write0
		...
		_, err = w.Write(buf.Bytes())
		if err != nil {
			slog.WarnContext(ctx, "failed to write result", "wasmcloud:couchbase/document@0.1.0-draft", "name", "get-all-replicas", "err", err)
			return
		}
		if len(writes) > 0 {
			for index, write := range writes {
				w, err := w.Index(index)
				if err != nil {
					slog.ErrorContext(ctx, "failed to index writer", "index", index, "wasmcloud:couchbase/document@0.1.0-draft", "name", "get-all-replicas", "err", err)
					return
				}
				index := index
				write := write
				go func() {
					if err := write(w); err != nil {
						slog.WarnContext(ctx, "failed to write nested result value", "index", index, "wasmcloud:couchbase/document@0.1.0-draft", "name", "get-all-replicas", "err", err)
					}
				}()
			}
		}
	...
	stop6, err := s.Serve("wasmcloud:couchbase/document@0.1.0-draft", "remove", func(ctx context.Context, w wrpc.IndexWriteCloser, r wrpc.IndexReadCloser) {
		...
		slog.DebugContext(ctx, "reading parameter", "i", 1)
		p1, err := func(r wrpc.IndexReader, path ...uint32) (*DocumentRemoveOptions, error) {
			slog.Debug("reading option status byte")
			status, err := r.ReadByte()
			if err != nil {
				return nil, fmt.Errorf("failed to read option status byte: %w", err)
			...
			case 1:
				slog.Debug("reading `option::some` payload")
				v, err := func(r wrpc.IndexReader, path ...uint32) (*DocumentRemoveOptions, error) {
		...
		if err != nil {
			slog.WarnContext(ctx, "failed to write result value", "i", 0, "wasmcloud:couchbase/document@0.1.0-draft", "name", "remove", "err", err)
			return
		}
		if write0 != nil {
			writes[0] = write0
		...
		_, err = w.Write(buf.Bytes())
		if err != nil {
			slog.WarnContext(ctx, "failed to write result", "wasmcloud:couchbase/document@0.1.0-draft", "name", "remove", "err", err)
			return
		}
		if len(writes) > 0 {
			for index, write := range writes {
				w, err := w.Index(index)
				if err != nil {
					slog.ErrorContext(ctx, "failed to index writer", "index", index, "wasmcloud:couchbase/document@0.1.0-draft", "name", "remove", "err", err)
					return
				}
				index := index
				write := write
				go func() {
					if err := write(w); err != nil {
						slog.WarnContext(ctx, "failed to write nested result value", "index", index, "wasmcloud:couchbase/document@0.1.0-draft", "name", "remove", "err", err)
					}
				}()
			}
		}
	...
	stop7, err := s.Serve("wasmcloud:couchbase/document@0.1.0-draft", "get-and-lock", func(ctx context.Context, w wrpc.IndexWriteCloser, r wrpc.IndexReadCloser) {
		...
		slog.DebugContext(ctx, "reading parameter", "i", 1)
		p1, err := func(r wrpc.IndexReader, path ...uint32) (*DocumentGetAndLockOptions, error) {
			slog.Debug("reading option status byte")
			status, err := r.ReadByte()
			if err != nil {
				return nil, fmt.Errorf("failed to read option status byte: %w", err)
			...
			case 1:
				slog.Debug("reading `option::some` payload")
				v, err := func(r wrpc.IndexReader, path ...uint32) (*DocumentGetAndLockOptions, error) {
		...
		if err != nil {
			slog.WarnContext(ctx, "failed to write result value", "i", 0, "wasmcloud:couchbase/document@0.1.0-draft", "name", "get-and-lock", "err", err)
			return
		}
		if write0 != nil {
			writes[0] = write0
		...
		_, err = w.Write(buf.Bytes())
		if err != nil {
			slog.WarnContext(ctx, "failed to write result", "wasmcloud:couchbase/document@0.1.0-draft", "name", "get-and-lock", "err", err)
			return
		}
		if len(writes) > 0 {
			for index, write := range writes {
				w, err := w.Index(index)
				if err != nil {
					slog.ErrorContext(ctx, "failed to index writer", "index", index, "wasmcloud:couchbase/document@0.1.0-draft", "name", "get-and-lock", "err", err)
					return
				}
				index := index
				write := write
				go func() {
					if err := write(w); err != nil {
						slog.WarnContext(ctx, "failed to write nested result value", "index", index, "wasmcloud:couchbase/document@0.1.0-draft", "name", "get-and-lock", "err", err)
					}
				}()
			}
		}
	...
	stop8, err := s.Serve("wasmcloud:couchbase/document@0.1.0-draft", "unlock", func(ctx context.Context, w wrpc.IndexWriteCloser, r wrpc.IndexReadCloser) {
		...
		slog.DebugContext(ctx, "reading parameter", "i", 1)
		p1, err := func(r wrpc.IndexReader, path ...uint32) (*DocumentUnlockOptions, error) {
			slog.Debug("reading option status byte")
			status, err := r.ReadByte()
			if err != nil {
				return nil, fmt.Errorf("failed to read option status byte: %w", err)
			...
			case 1:
				slog.Debug("reading `option::some` payload")
				v, err := func(r wrpc.IndexReader, path ...uint32) (*DocumentUnlockOptions, error) {
		...
		if err != nil {
			slog.WarnContext(ctx, "failed to write result value", "i", 0, "wasmcloud:couchbase/document@0.1.0-draft", "name", "unlock", "err", err)
			return
		}
		if write0 != nil {
			writes[0] = write0
		...
		_, err = w.Write(buf.Bytes())
		if err != nil {
			slog.WarnContext(ctx, "failed to write result", "wasmcloud:couchbase/document@0.1.0-draft", "name", "unlock", "err", err)
			return
		}
		if len(writes) > 0 {
			for index, write := range writes {
				w, err := w.Index(index)
				if err != nil {
					slog.ErrorContext(ctx, "failed to index writer", "index", index, "wasmcloud:couchbase/document@0.1.0-draft", "name", "unlock", "err", err)
					return
				}
				index := index
				write := write
				go func() {
					if err := write(w); err != nil {
						slog.WarnContext(ctx, "failed to write nested result value", "index", index, "wasmcloud:couchbase/document@0.1.0-draft", "name", "unlock", "err", err)
					}
				}()
			}
		}
	...
	stop9, err := s.Serve("wasmcloud:couchbase/document@0.1.0-draft", "touch", func(ctx context.Context, w wrpc.IndexWriteCloser, r wrpc.IndexReadCloser) {
		...
		slog.DebugContext(ctx, "reading parameter", "i", 1)
		p1, err := func(r wrpc.IndexReader, path ...uint32) (*DocumentTouchOptions, error) {
			slog.Debug("reading option status byte")
			status, err := r.ReadByte()
			if err != nil {
				return nil, fmt.Errorf("failed to read option status byte: %w", err)
			...
			case 1:
				slog.Debug("reading `option::some` payload")
				v, err := func(r wrpc.IndexReader, path ...uint32) (*DocumentTouchOptions, error) {
		...
		if err != nil {
			slog.WarnContext(ctx, "failed to write result value", "i", 0, "wasmcloud:couchbase/document@0.1.0-draft", "name", "touch", "err", err)
			return
		}
		if write0 != nil {
			writes[0] = write0
		...
		_, err = w.Write(buf.Bytes())
		if err != nil {
			slog.WarnContext(ctx, "failed to write result", "wasmcloud:couchbase/document@0.1.0-draft", "name", "touch", "err", err)
			return
		}
		if len(writes) > 0 {
			for index, write := range writes {
				w, err := w.Index(index)
				if err != nil {
					slog.ErrorContext(ctx, "failed to index writer", "index", index, "wasmcloud:couchbase/document@0.1.0-draft", "name", "touch", "err", err)
					return
				}
				index := index
				write := write
				go func() {
					if err := write(w); err != nil {
						slog.WarnContext(ctx, "failed to write nested result value", "index", index, "wasmcloud:couchbase/document@0.1.0-draft", "name", "touch", "err", err)
					}
				}()
			}
		}
	...
	stop10, err := s.Serve("wasmcloud:couchbase/document@0.1.0-draft", "get-and-touch", func(ctx context.Context, w wrpc.IndexWriteCloser, r wrpc.IndexReadCloser) {
		...
		slog.DebugContext(ctx, "reading parameter", "i", 1)
		p1, err := func(r wrpc.IndexReader, path ...uint32) (*DocumentGetAndTouchOptions, error) {
			slog.Debug("reading option status byte")
			status, err := r.ReadByte()
			if err != nil {
				return nil, fmt.Errorf("failed to read option status byte: %w", err)
			...
			case 1:
				slog.Debug("reading `option::some` payload")
				v, err := func(r wrpc.IndexReader, path ...uint32) (*DocumentGetAndTouchOptions, error) {
		...
		if err != nil {
			slog.WarnContext(ctx, "failed to write result value", "i", 0, "wasmcloud:couchbase/document@0.1.0-draft", "name", "get-and-touch", "err", err)
			return
		}
		if write0 != nil {
			writes[0] = write0
		...
		_, err = w.Write(buf.Bytes())
		if err != nil {
			slog.WarnContext(ctx, "failed to write result", "wasmcloud:couchbase/document@0.1.0-draft", "name", "get-and-touch", "err", err)
			return
		}
		if len(writes) > 0 {
			for index, write := range writes {
				w, err := w.Index(index)
				if err != nil {
					slog.ErrorContext(ctx, "failed to index writer", "index", index, "wasmcloud:couchbase/document@0.1.0-draft", "name", "get-and-touch", "err", err)
					return
				}
				index := index
				write := write
				go func() {
					if err := write(w); err != nil {
						slog.WarnContext(ctx, "failed to write nested result value", "index", index, "wasmcloud:couchbase/document@0.1.0-draft", "name", "get-and-touch", "err", err)
					}
				}()
			}
		}
