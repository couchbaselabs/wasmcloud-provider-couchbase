...
func ServeInterface(s wrpc.Server, h Handler) (stop func() error, err error) {
	...
	stop0, err := s.Serve("wasmcloud:couchbase/document@0.1.0-draft", "insert", func(ctx context.Context, w wrpc.IndexWriter, r wrpc.IndexReadCloser) error {
		...
		if err != nil {
			return fmt.Errorf("failed to handle `wasmcloud:couchbase/document@0.1.0-draft.insert` invocation: %w", err)
		}
	...
	stop1, err := s.Serve("wasmcloud:couchbase/document@0.1.0-draft", "replace", func(ctx context.Context, w wrpc.IndexWriter, r wrpc.IndexReadCloser) error {
		slog.DebugContext(ctx, "reading parameter", "i", 0)
		p0, err := func() (DocumentId, error) {
			v, err := func() (wasmcloud__couchbase__types.DocumentId, error) {
				v, err := func(r interface {
		...
		if err != nil {
			return fmt.Errorf("failed to handle `wasmcloud:couchbase/document@0.1.0-draft.replace` invocation: %w", err)
		}
	...
	stop2, err := s.Serve("wasmcloud:couchbase/document@0.1.0-draft", "upsert", func(ctx context.Context, w wrpc.IndexWriter, r wrpc.IndexReadCloser) error {
		slog.DebugContext(ctx, "reading parameter", "i", 0)
		p0, err := func() (DocumentId, error) {
			v, err := func() (wasmcloud__couchbase__types.DocumentId, error) {
				v, err := func(r interface {
		...
		if err != nil {
			return fmt.Errorf("failed to handle `wasmcloud:couchbase/document@0.1.0-draft.upsert` invocation: %w", err)
		}
	...
	stop3, err := s.Serve("wasmcloud:couchbase/document@0.1.0-draft", "get", func(ctx context.Context, w wrpc.IndexWriter, r wrpc.IndexReadCloser) error {
		slog.DebugContext(ctx, "reading parameter", "i", 0)
		p0, err := func() (DocumentId, error) {
			v, err := func() (wasmcloud__couchbase__types.DocumentId, error) {
				v, err := func(r interface {
		...
		if err != nil {
			return fmt.Errorf("failed to handle `wasmcloud:couchbase/document@0.1.0-draft.get` invocation: %w", err)
		}
	...
	stop4, err := s.Serve("wasmcloud:couchbase/document@0.1.0-draft", "get-any-repliacs", func(ctx context.Context, w wrpc.IndexWriter, r wrpc.IndexReadCloser) error {
		slog.DebugContext(ctx, "reading parameter", "i", 0)
		p0, err := func() (DocumentId, error) {
			v, err := func() (wasmcloud__couchbase__types.DocumentId, error) {
				v, err := func(r interface {
		...
		if err != nil {
			return fmt.Errorf("failed to handle `wasmcloud:couchbase/document@0.1.0-draft.get-any-repliacs` invocation: %w", err)
		}
	...
	stop5, err := s.Serve("wasmcloud:couchbase/document@0.1.0-draft", "get-all-replicas", func(ctx context.Context, w wrpc.IndexWriter, r wrpc.IndexReadCloser) error {
		slog.DebugContext(ctx, "reading parameter", "i", 0)
		p0, err := func() (DocumentId, error) {
			v, err := func() (wasmcloud__couchbase__types.DocumentId, error) {
				v, err := func(r interface {
		...
		if err != nil {
			return fmt.Errorf("failed to handle `wasmcloud:couchbase/document@0.1.0-draft.get-all-replicas` invocation: %w", err)
		}
	...
	stop6, err := s.Serve("wasmcloud:couchbase/document@0.1.0-draft", "remove", func(ctx context.Context, w wrpc.IndexWriter, r wrpc.IndexReadCloser) error {
		slog.DebugContext(ctx, "reading parameter", "i", 0)
		p0, err := func() (DocumentId, error) {
			v, err := func() (wasmcloud__couchbase__types.DocumentId, error) {
				v, err := func(r interface {
		...
		if err != nil {
			return fmt.Errorf("failed to handle `wasmcloud:couchbase/document@0.1.0-draft.remove` invocation: %w", err)
		}
	...
	stop7, err := s.Serve("wasmcloud:couchbase/document@0.1.0-draft", "get-and-lock", func(ctx context.Context, w wrpc.IndexWriter, r wrpc.IndexReadCloser) error {
		slog.DebugContext(ctx, "reading parameter", "i", 0)
		p0, err := func() (DocumentId, error) {
			v, err := func() (wasmcloud__couchbase__types.DocumentId, error) {
				v, err := func(r interface {
		...
		if err != nil {
			return fmt.Errorf("failed to handle `wasmcloud:couchbase/document@0.1.0-draft.get-and-lock` invocation: %w", err)
		}
	...
	stop8, err := s.Serve("wasmcloud:couchbase/document@0.1.0-draft", "unlock", func(ctx context.Context, w wrpc.IndexWriter, r wrpc.IndexReadCloser) error {
		slog.DebugContext(ctx, "reading parameter", "i", 0)
		p0, err := func() (DocumentId, error) {
			v, err := func() (wasmcloud__couchbase__types.DocumentId, error) {
				v, err := func(r interface {
		...
		if err != nil {
			return fmt.Errorf("failed to handle `wasmcloud:couchbase/document@0.1.0-draft.unlock` invocation: %w", err)
		}
	...
	stop9, err := s.Serve("wasmcloud:couchbase/document@0.1.0-draft", "touch", func(ctx context.Context, w wrpc.IndexWriter, r wrpc.IndexReadCloser) error {
		slog.DebugContext(ctx, "reading parameter", "i", 0)
		p0, err := func() (DocumentId, error) {
			v, err := func() (wasmcloud__couchbase__types.DocumentId, error) {
				v, err := func(r interface {
		...
		if err != nil {
			return fmt.Errorf("failed to handle `wasmcloud:couchbase/document@0.1.0-draft.touch` invocation: %w", err)
		}
	...
	stop10, err := s.Serve("wasmcloud:couchbase/document@0.1.0-draft", "get-and-touch", func(ctx context.Context, w wrpc.IndexWriter, r wrpc.IndexReadCloser) error {
		slog.DebugContext(ctx, "reading parameter", "i", 0)
		p0, err := func() (DocumentId, error) {
			v, err := func() (wasmcloud__couchbase__types.DocumentId, error) {
				v, err := func(r interface {
		...
		if err != nil {
			return fmt.Errorf("failed to handle `wasmcloud:couchbase/document@0.1.0-draft.get-and-touch` invocation: %w", err)
		}
